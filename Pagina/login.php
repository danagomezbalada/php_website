...
<body>
    ...
    <header class=" w3-top w3-black w3-card">
        <div class="w3-bar">
          ...
          <a href='login.php' style="text-decoration: none"><button class="w3-bar-item w3-button boto w3-padding-large w3-hide-small w3-right w3-dark-grey">Log In</button></a>
        </div>
        ...
        <div id="navPetit" class="w3-bar-block w3-hide w3-black w3-hide-large w3-hide-medium w3-top" style="margin-top:46px">
            ...
            <a href='login.php' style="text-decoration: none"><button class="w3-bar-item w3-button w3-padding-large">Log In</button></a>
        </div>
    </header>
        <br><br>
    <!-- Login -->
    <div id="Login" class="w3-modal-content w3-card-4 w3-animate-zoom" style="max-width:600px; margin-top:50px; margin-bottom:50px"><br>
        <div class="w3-center">
        ...
        <form class="w3-container w3-section" action="" method="post">
            ...
            <input type="submit" name="search" value="Log In" class="w3-button w3-block w3-purple w3-section w3-padding">
            <span class="w3-right" style="padding-bottom:30px">Not a user? <a href="signup.php">Sign up</a></span>
        </form>
    </div>
    <?php
        require("Users.php");
        ...
        function loadUser(){
            ...
            $save_user = "SELECT * FROM `users` WHERE username = `username` AND password = `password` ";
            $result = mysqli_query($connection, $save_user);
            $fila = mysqli_fetch_assoc($result);
            echo 'Name: ' . $fila["username"] . ' Password: ' . $fila["password"] . ' Email: '. $fila["email"];
